class SampleApp extends (window['CotApp'] || window['cot_app']) {
  constructor() {
    super();
    this.$container = $('#bdit_core_transit_container');
  ...
  showSection(sectionId){
    this.$('#bdit_core_transit_' + this.currentlySelectedSection).hide();
    this.$('a[href*="#bdit_core_transit_"]').removeClass('selected-section');
    this.$('#bdit_core_transit_' + sectionId).show();
    this.$(`a[href="#bdit_core_transit_${sectionId}"]`).addClass('selected-section');
  ...
  renderExampleSection_form(){
    let form = new ExampleForm(this.$('#bdit_core_transit_form > div'));
    form.render();
    this.$('#bdit_core_transit_form > p > button').on('click', function(){
  ...
  renderExampleSection_map() {
    let map = new ExampleGoogleMap(this.$('#bdit_core_transit_map > div'),false);
    map.render();
    map.addMarker({
  ...
  renderExampleSection_calendar() {
    this.$('#bdit_core_transit_calendar > div').fullCalendar({
      theme: false,
      contentHeight: 'auto',
  ...
  renderExampleSection_login() {
    let login = new cot_login({
      ...
      welcomeSelector: '#bdit_core_transit_login > div', //Optional, a jquery selector string for the element where the login/logout information should be displayed
